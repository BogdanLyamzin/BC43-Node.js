...
const {isValidId, authenticate, upload, isEmptyFile} = require("../../middlewares");
...
router.post("/", upload.single("cover"), isEmptyFile, validateBody(schemas.bookAddSchema), booksController.addBook);
